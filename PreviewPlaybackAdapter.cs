...
namespace Cosmos.Timeline.Playback.Editor
{
    ...
    public class PreviewPlaybackAdapter : MonoBehaviour
    {
        ...
        public void PlayTimelineByName(string timelineName)
        {
            ...
            {
                Debug.LogWarning("[PreviewAdapter] Timeline config not loaded");
                return;
            }

            TimelineDataSO timeline = timelineConfig.GetTimelineByState(timelineName);
            if (timeline != null)
            {
        ...
        public CharacterTimelineConfig TimelineConfig => timelineConfig;
