...
public class FollowHistoryController : BaseController
{
    // 아래 코드는 필수 코드 입니다.
    ...
    public override UIType UIType { get { return UIType.FollowHistoryView; } }
    private FollowHistoryView View { get { return base.BaseView as FollowHistoryView; } }
    protected FollowHistoryViewModel Model { get; private set; }
    public FollowHistoryController() { Model = GetModel<FollowHistoryViewModel>(); }
    public FollowHistoryController(BaseModel baseModel) : base(baseModel) { }
    //=========================================================================================================
    //============================================================
    ...
    {
        Model.SetFollowHistoryUnitModels(PlayerManager.Instance.MyPlayer.User.CharacterModel);
    ...
    {
        NaviiChatManager.ExitAllNaviiChatView(UIType.FollowHistoryView);
    ...
    {
        return StringDefine.PATH_PREFAB_UI_CONTENTS + "NaviiChat/FollowHistoryView";
    }
    ...
    private void OnEventHome()
    {
        if (NaviiChatManager.Instance.IsContainNaviiChatViewGroup(UIManager.Instance.GetBackUIType()))
            ...
            UIManager.Instance.EnterAsync(UIType.NaviiChatView).Forget();
    }
