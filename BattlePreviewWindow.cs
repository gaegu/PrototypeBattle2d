...
public class BattlePreviewWindow : EditorWindow
{
    ...
    private CharacterTimelineConfig currentTimelineConfig;
    ...
    private void DrawTimelineControls()
    {
        ...
        // Timeline 선택
        if (playbackAdapter.TimelineConfig != null)
        {
            if (GUILayout.Button("Attack1"))
                playbackAdapter.PlayTimeline(playbackAdapter.TimelineConfig.attack1Timeline);
            if (GUILayout.Button("ActiveSkill1"))
                playbackAdapter.PlayTimeline(playbackAdapter.TimelineConfig.activeSkill1Timeline);
            if (GUILayout.Button("PassiveSkill1"))
                playbackAdapter.PlayTimeline(playbackAdapter.TimelineConfig.passiveSkill1Timeline);
        ...
        if (previewCharacter != null)
        {
            ...
            {
                // 가능한 Timeline 패턴들
                string[] timelinePatterns = { "Attack1", "ActiveSkill1", "PassiveSkill1", "Victory", "Hit" };
