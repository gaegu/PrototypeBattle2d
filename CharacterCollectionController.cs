...
public class CharacterCollectionController : BaseController
{
    // 아래 코드는 필수 코드 입니다.
    ...
    public override UIType UIType { get { return UIType.CharacterCollectionView; } }
    public override void SetModel() { SetModel(new CharacterCollectionViewModel()); }
    private CharacterCollectionView View { get { return base.BaseView as CharacterCollectionView; } }
    private CharacterCollectionViewModel Model { get { return GetModel<CharacterCollectionViewModel>(); } }
    //=========================================================================================================
    //============================================================
    ...
    {
        return StringDefine.PATH_PREFAB_UI_CONTENTS + "Character/CharacterCollectionView";
    }
    ...
    private ThumbnailSelectType OnEventCharacterSelect(BaseThumbnailUnitModel model)
    {
        ...
        viewModel.DateSetting(model.Goods as Character);
        viewModel.SetDetailButton(PlayerManager.Instance.MyPlayer.User.CharacterModel.GetGoodsByDataId(model.Goods.DataId) != null);

        UIManager.Instance.EnterAsync(controller, onEventExtra: async (state) =>
        {
            if (state == UISubState.AfterLoading)
                AdditivePrefabManager.Instance.UnLoadAsync(AdditiveType.CharacterSignature).Forget();
        }).Forget();
