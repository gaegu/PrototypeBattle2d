...
public class PhoneCallController : BaseController
{
    ...
    public override UIType UIType { get { return UIType.PhoneCallPopup; } }
    public override void SetModel() { SetModel(new PhoneCallPopupModel()); }
    private PhoneCallPopup View { get { return base.BaseView as PhoneCallPopup; } }
    private PhoneCallPopupModel Model { get { return GetModel<PhoneCallPopupModel>(); } }
    //=========================================================================================================
    //============================================================
    ...
    public override void InitializeTestModel(params object[] parameters)
    {
        ...
        Model.SetCallerThumbModel(cooperModel);
        Model.SetRecevierThumbModel(beatModel);
        ...
        for (int i = 0; i < scripts.Length; i++)
        {
            ...
            Model.AddCharacterTalkUnitModel(model);
        }
    ...
    public override void Enter()
    {
        ...
        Model.SetOnEventReceiveCall(OnEventReceiveCall);
        Model.SetOnEventEnd(OnEventEnd);
    }
    ...
    {
        return StringDefine.PATH_PREFAB_UI_CONTENTS + "PhoneCall/PhoneCallPopup";
    }

    private void OnEventReceiveCall()
    {
        if (Model.CurrentState == PhoneCallPopupModel.State.Calling)
            return;

        Model.SetCurrentState(PhoneCallPopupModel.State.Calling);
        View.ShowAsync().Forget();
    }

    private void OnEventEnd()
    {
        IronJade.Debug.Log("End : PhoneCallPopup");
        Exit().Forget();
    }
