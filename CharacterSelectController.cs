...
public class CharacterSelectController : BaseController
{
    // 아래 코드는 필수 코드 입니다.
    ...
    public override UIType UIType { get { return UIType.CharacterSelectPopup; } }
    private CharacterSelectPopup View { get { return base.BaseView as CharacterSelectPopup; } }
    protected CharacterSelectPopupModel Model { get; private set; }
    public CharacterSelectController() { Model = GetModel<CharacterSelectPopupModel>(); }
    public CharacterSelectController(BaseModel baseModel) : base(baseModel) { }
    //=========================================================================================================
    //============================================================
    ...
    public override void Enter()
    {
        ...
        Model.SetEventChangeFilter(OnEventChangeFilter);
        ...
        Model.SetCategory(LicenseType.None);

        Model.SetSelectThumbnailCharacter(null);
    ...
    {
        if (!Model.CheckConfirm())
            return;

        Model.OnEventConfirmFinished(Model.SelectThumbnailCharacterUnitModel);
    }
    ...
    {
        return StringDefine.PATH_PREFAB_UI_CONTENTS + "Common/CharacterSelectPopup";
    }
