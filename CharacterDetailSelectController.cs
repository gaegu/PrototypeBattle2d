...
public class CharacterDetailSelectController : BaseController
{
    // 아래 코드는 필수 코드 입니다.
    ...
    public override UIType UIType { get { return UIType.CharacterDetailSelectPopup; } }
    public override void SetModel() { SetModel(new CharacterDetailSelectPopupModel()); }
    private CharacterDetailSelectPopup View { get { return base.BaseView as CharacterDetailSelectPopup; } }
    private CharacterDetailSelectPopupModel Model { get { return GetModel<CharacterDetailSelectPopupModel>(); } }
    ...
    {
        return StringDefine.PATH_PREFAB_UI_CONTENTS + "Character/CharacterDetailSelectPopup";
    }
